  ...
  二、count  max 的优化方法
   ...
   四、group by 查询优化
    ...
    六、索引优化
        ...
        2014 / 07至 2015 / 05
郑州玖零科技有限公司 |  PHP开发
项目：使用ThinkPHP框架开发的商城
      ,其中包括会员管理,栏目管理,
      商品管理,订单管理,
      商品评论,购物车模块,在线支付等
工作内容:后台栏目分类添加功能,前台栏目无限极分类循环输出并展示;
      后台添加商品及信息自动验证,自动填充;商品评论功能的实现

2014 / 09至 2016 / 06
北京玖盈财富投资管理有限公司 |  PHP开发
项目:负责新版网站论坛系统的开发；
    Laravel框架实现金融项目借款,还款,并提现的功能,
工作内容:项目中用到数据迁移,中间件功能,blade模板,artisan命令,
    实现认证及授权个人信息设置模块,用到Laravel的信息验证,ajax技术等;

2016 / 07至今
啄木鸟国际教育（北京）有限公司 | PHP开发
项目：做留学本高转学研究生申请项目，财务台账系统，销售工具
工作内容：主要使用ThinkPHP框架，对项目中部门权限进行控制
        留学业务流程进行功能的实现
        财务留学和培训台账月底对账功能的实现
        销售工具校库内容搜索功能的实现
